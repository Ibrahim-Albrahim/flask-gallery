...
const Manage = () => {    
    useEffect(() => {
        ...
        const activeLi = 'background-color: inherit; border: none; color: hsl(39, 77%, 83% , 1); transform: scale(1.1)'
        ...
        const labelSuccess = 'border: none;'
        ...
        btnList[0].addEventListener('click', async(event)=> {
            ...
            if (formInputs[0].value.length && formInputs[1].files.length && password[1].value.length !== 0) {
                ...
                password[0].style.cssText = labelSuccess
        ...
        checkbox.addEventListener('click', () => {
            if (checkbox.checked === true){ 
                metatagsGrp.style.cssText = 'visibility: visible; opacity: 1; position: unset;'
            } else {metatagsGrp.style.cssText = 'visibility: hidden; opacity: 0; position: absolute;'}
                ...
                if ( formInputs[1].value.length + formInputs[2].files.length !== 0 || checkbox.checked === true){
                    ...
                    if (checkbox.checked === true){
                        ...
                        if ( metatagesInputsValues !== 0 ){
                            metatagesLabels.forEach(lbl => lbl.style.cssText = labelSuccess)
        ...
        deleteBtnList.forEach( btn => btn.addEventListener('click', async function () { 
            ...
            if ( formInput.value.length !== 0 ){
                formLabel.style.cssText = labelSuccess
                if ( password[1].value.length !== 0 ){
                    password[0].style.cssText = labelSuccess
                    btn.disabled = true;
                    loadingBubbles.style.display = 'unset'
    ...
    return (
        <div className="create-container">
            <Header headerText='Manage Gallery' headerLink='/' icon={faArrowAltCircleLeft} clsName='faArrowAltCircleLeft'/>
            <section>
                ...
                <Form id='full-form'>
                    ...
                    <Form.Group className='form-btns'>
                        ...
                        <Form.Group id='delete-btns'>
                            <Button id='delete-gallery-btn' >Delete Gallery</Button>
